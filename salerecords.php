...
<nav role='navigation'>
  <ul class="main">
      <li class="dashboard"><a href="saleadmin.php">Database</a></li>
    <li class="edit"><a href="saleslider.php">Saleslider</a></li>
    <li class="write"><a href="slirecords.php">Slirecords</a></li>
    <li class="edit"><a href="carddata.php">Carddata</a></li>
    <li class="write"><a href="carddatarecords.php">Carddatarecords</a></li>
    ...
    <table> 
        ...
        <tbody> 
            ...
            <tr> 
                  ...
                  <td><img src="photo/<?php echo $rows['image'];?>" height="auto;" width="auto;"></td>
